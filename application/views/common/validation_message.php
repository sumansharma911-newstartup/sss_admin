<script type="text/javascript">
    ...
    var usernamePolicyValidationMessage = '<?php echo USERNAME_POLICY_MESSAGE ?>';
    ...
    var designationValidationMessage = '<?php echo DESIGNATION_MESSAGE; ?>';
    var sdURLValidationMessage = '<?php echo SERVICE_DELIVERY_URL_MESSAGE; ?>';
    var noOfDaysValidationMessage = '<?php echo NO_DAYS_MESSAGE; ?>';
    var oneDocREQValidationMessage = '<?php echo ONE_DOC_REQ_MESSAGE; ?>';
    var otherDSCategoryValidationMessage = '<?php echo OTHER_DS_CATEGORY_MESSAGE; ?>';
    var descriptionValidationMessage = '<?php echo DESCRIPTION_MESSAGE; ?>';
    var feesValidationMessage = '<?php echo FEES_MESSAGE; ?>';
    var oneFeeValidationMessage = '<?php echo ONE_FEES_MESSAGE; ?>';
    var paymentValidationMessage = '<?php echo PAYMENT_MESSAGE; ?>';
    var onePaymentValidationMessage = '<?php echo ONE_PAYMENT_MESSAGE; ?>';
</script>